          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-600 mt-1">{formatted.description}</div>
                  ...
                  <div className="mt-2 p-2 bg-gray-50 rounded text-xs">
                    {event.beforeValue && (
                      <div className="text-red-600 mb-1">
                        <span className="font-medium">Before:</span> {truncateText(event.beforeValue, 150)}
                      </div>
                    )}
                    {event.afterValue && (
                      <div className="text-green-600">
                        <span className="font-medium">After:</span> {truncateText(event.afterValue, 150)}
                      </div>
                    )}
                  </div>
                ) : null}
