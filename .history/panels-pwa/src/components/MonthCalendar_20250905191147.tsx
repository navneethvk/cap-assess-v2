      ...
      <div className="flex-grow p-3 sm:p-4 pb-16 sm:pb-20">
        <div className="w-full max-w-4xl mx-auto">
          <Card className="home-card">
            <CardHeader className="px-3 sm:px-4 py-3 flex flex-row items-center justify-between">
              <div className="flex items-center">
                ...
                >
                  <SelectTrigger className="w-24 h-6 text-xs rounded-full px-3 border-gray-300">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex items-center gap-1">
                <Button
                  size="sm"
                  variant="outline"
                  className="h-6 w-6 p-0 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors"
                  asChild
                >
                  <Link to="/timeline">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="h-6 w-6 p-0 rounded-full border border-gray-300 bg-primary text-primary-foreground"
                  asChild
                >
                  <Link to="/calendar">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="h-6 px-2 text-xs rounded-full border border-gray-300 hover:bg-gray-100 transition-colors"
                  onClick={() => {
                    const today = new Date();
