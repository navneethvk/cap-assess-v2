...
const VisitsTimeline: React.FC = () => {
  ...
  return (
    <div id="visits-timeline-root" className="mt-4 relative">
      ...
      <div
        className="absolute left-1/2 top-0 bottom-0 -translate-x-1/2 w-24 z-20 pointer-events-auto opacity-0"
        onMouseMove={(e) => {
      ...
      >
        ...
        <div id="spine-add-indicator" style={{ display: 'none' }} className="pointer-events-auto absolute left-1/2 -translate-x-1/2 z-5">
          <button
            type="button"
