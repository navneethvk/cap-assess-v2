...
const CreateVisitForm: React.FC<CreateVisitFormProps> = ({
  ...
  const cciLegend = React.useMemo(() => {
    if (showAllCcis || institutionOptions.length === 0) return null
    return 'My CCIs'
  }, [institutionOptions.length, showAllCcis])
      ...
      <div className="w-full max-w-screen-2xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            {!showAllCcis && (
              <p className="text-xs text-muted-foreground mb-1">My CCIs</p>
            )}
            <TextSelect
              value={selectedCciId}
