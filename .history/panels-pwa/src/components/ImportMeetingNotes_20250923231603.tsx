      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex gap-2 flex-wrap">
            <Button variant="primary" size="primary-default" onClick={triggerUpload}>Upload CSV</Button>
            ...
            {built && (
              <Button variant="primary" size="primary-default" onClick={() => setStage('confirm')} disabled={materialized.every((p: any) => !p.ok)}>
                Import rows
              </Button>
            )}
          </div>
        ...
        <Card>
          <CardHeader className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="primary" size="primary-default" onClick={() => { setCciMap(pendingCciMap); setEmMap(pendingEmMap); setStage('preview') }}>Apply mappings</Button>
            </div>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="primary" size="primary-default" onClick={importNow} disabled={isImporting || materialized.filter(r => r.ok).length === 0}>
