        ...
        {expanded && !anyDragging && isDirty && (
          <div className="absolute top-2 right-2 flex flex-col gap-2" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              className="h-8 w-8 rounded-full border border-slate-300 bg-white shadow-sm flex items-center justify-center hover:bg-slate-50"
              onClick={() => { setAgenda(baseAgenda); setDebrief(baseDebrief); }}
            >
            ...
            <button
              ...
              className="h-8 w-8 rounded-full border border-blue-300 bg-white shadow-sm flex items-center justify-center hover:bg-blue-50"
              onClick={async () => { await save({ agenda, debrief }); setBaseAgenda(agenda); setBaseDebrief(debrief); }}
            >
