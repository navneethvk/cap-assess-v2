    ...
    const center = (
      <div className="relative">
        <input
          ...
          className="font-semibold text-center bg-transparent border-none outline-none cursor-pointer hover:bg-gray-100 rounded px-2 py-1 text-sm"
          style={{ 
            colorScheme: 'light',
        ...
        />
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none text-sm font-semibold">
