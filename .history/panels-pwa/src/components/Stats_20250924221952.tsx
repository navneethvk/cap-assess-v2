...
import { useWeeklyVisitsCount, useInsightDataWithFallback } from '@/hooks/useInsightData'
...
const Stats: React.FC = () => {
  ...
  const { data: insightData, loading: insightLoading, error: insightError, useFallback, dataSource } = useInsightDataWithFallback({
  ...
  const participants = useMemo(() => {
    if (useFallback) {
      ...
      for (const weekData of insightData) {
        // For now, we'll need to get user IDs from the aggregated data
