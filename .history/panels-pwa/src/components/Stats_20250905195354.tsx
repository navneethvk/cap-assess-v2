              ...
              <div className="overflow-auto -mx-4 sm:mx-0">
                <div className="min-w-full px-4 sm:px-0">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="sticky left-0 bg-background z-10 min-w-[120px] sm:min-w-[200px] text-xs sm:text-sm">
                          <span className="hidden sm:inline">Week</span>
                          <span className="sm:hidden">W</span>
                        </TableHead>
                        {participants.map(p => (
                          <TableHead key={p.uid} className="min-w-[80px] sm:min-w-[120px] text-center text-xs sm:text-sm">
                            <div className="break-words max-w-[60px] sm:max-w-none">
