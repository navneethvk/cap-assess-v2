...
const AssignUsers: React.FC = () => {
  const { data: users, isLoading: loadingUsers } = useFirestoreCollection<User>(usersCollection(), {
    revalidateOnFocus: false,
    revalidateIfStale: false
  });
  const { data: ccis, isLoading: loadingCcis } = useFirestoreCollection<CCI>(ccisCollection(), {
    revalidateOnFocus: false,
    revalidateIfStale: false
  });
  const { data: cciUserLinks, isLoading: loadingLinks, mutate: mutateLinks } = useFirestoreCollection<CciUserLink>(cciUserLinksCollection(), {
    revalidateOnFocus: false,
    revalidateIfStale: false
  });
