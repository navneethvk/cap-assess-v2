      ...
      {displayVisits.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 px-4">
          ...
          <div className="text-sm text-muted-foreground text-center max-w-sm mb-4">
            No visits found for {new Date(displayVisits.length === 0 ? new Date() : displayVisits[0]?.date).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
          </div>
