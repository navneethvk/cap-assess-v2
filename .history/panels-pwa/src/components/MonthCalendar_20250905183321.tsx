  ...
  while (day <= endDate) {
    for (let i = 0; i < 7; i++) {
      ...
      days.push(
        <div
          key={day.toString()}
          className={`min-h-[60px] md:min-h-[80px] p-0.5 md:p-1 border border-gray-200 ${
        ...
        >
          ...
          <div className="space-y-0.5 md:space-y-1">
            {dayVisits.slice(0, 2).map((visit) => (
              <div
                key={visit.id}
                className={`bg-white rounded-sm px-1 py-0.5 text-[10px] md:text-xs shadow-sm ${
                  visit.filledBy === 'EM' 
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="truncate flex-1 text-[9px] md:text-[10px] leading-tight">
                    {visit.cci_name}
                  </div>
            ...
            {dayVisits.length > 2 && (
              <div className="text-[8px] md:text-[8px] text-gray-500 text-center px-1">
        ...
        <div className="w-full max-w-4xl mx-auto">
          <Card className="home-card">
            ...
            <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
              ...
              {/* Legend for mobile */}
              <div className="md:hidden flex items-center justify-center gap-3 text-[10px]">
