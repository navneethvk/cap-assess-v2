...
import { Users, Building2, UserPlus, Sparkles, Save, AlertTriangle, ChevronDown, Search as SearchIcon, X, Pencil } from 'lucide-react';
...
const UserSettings: React.FC = () => {
  ...
  // reserved for future dashboard summaries
                ...
                <CardHeader className="m3-card-header">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="outline" className="rounded-full border-2" onClick={() => setAddingUser(true)}>+ Add User</Button>
