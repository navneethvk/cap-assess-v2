...
const DayView: React.FC = () => {
  ...
  // Title bar slots: center = date picker, right = today button
  useEffect(() => {
    ...
    const right = (
      <Button
        size="sm"
        variant="outline"
        className="h-7 px-3 text-xs border border-border bg-background text-foreground hover:bg-muted transition-colors flex items-center gap-1"
        onClick={goToToday}
        title="Go to today"
      >
    ...
    console.log('DayView - Setting title bar slots:', { center: !!center, right: !!right })
