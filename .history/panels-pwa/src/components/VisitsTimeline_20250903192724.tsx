...
const TimelineCard: React.FC<{ v: VisitDoc; onUpdated: () => void; onDragStart: (e: React.DragEvent, visit: VisitDoc) => void; onDragOver: (e: React.DragEvent) => void; onDrop: (e: React.DragEvent, visit: VisitDoc) => void; isDragging: boolean; anyDragging: boolean }> = ({ v, onUpdated, onDragStart, onDragOver, onDrop, isDragging, anyDragging }) => {
