...
const DayView: React.FC = () => {
  ...
  useEffect(() => {
    const center = (
      <div className="relative border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors min-w-[100px] overflow-hidden">
        <div className="px-3 py-2 text-center">
          <span className="font-semibold text-sm select-none pointer-events-none">
