                  ...
                  <Table className="text-[8px] sm:text-sm">
                    <TableHeader>
                      ...
                      <TableRow className="bg-gray-100">
                        <TableHead className="sticky left-0 bg-gray-100 z-10 min-w-[100px] sm:min-w-[200px] font-bold text-[8px] sm:text-sm">
                          <span className="hidden sm:inline">Total</span>
                          <span className="sm:hidden">T</span>
                        </TableHead>
                        {participants.map(p => {
                          ...
                          return (
                            <TableHead key={p.uid} className="min-w-[60px] sm:min-w-[120px] text-center font-bold text-[8px] sm:text-sm">
                              {colTotal}
                            </TableHead>
                          )
                        })}
                    ...
                    <TableBody>
                      {rows.weeks.map(([key, meta]) => {
                        ...
                        return (
                                                  <TableRow key={key}>
                          <TableCell className="font-medium sticky left-0 bg-background z-10 min-w-[100px] sm:min-w-[200px] text-[8px] sm:text-sm">
                          ...
                          {participants.map(p => (
                            <TableCell key={p.uid} className="text-center text-[8px] sm:text-sm">{row.get(p.uid) || 0}</TableCell>
                          ))}
                          <TableCell className="text-center font-bold bg-gray-100 text-[8px] sm:text-sm">{rowTotal}</TableCell>
                        </TableRow>
                        )
                      })}
                    </TableBody>
