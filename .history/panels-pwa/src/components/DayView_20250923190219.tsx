...
const DayView: React.FC = () => {
  ...
  // Handle click on date box to open picker
  const handleDateBoxClick = () => {
    // Create a temporary input element and trigger its click
    const tempInput = document.createElement('input');
    tempInput.type = 'date';
    tempInput.value = formatDateForHTMLInput(selectedDate);
  ...
  useEffect(() => {
    const center = (
      <div className="relative">
        <div className="border border-gray-300 px-3 py-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors min-w-[100px] text-center">
