              ...
              <div className="overflow-auto -mx-4 sm:mx-0">
                <div className="min-w-full px-2 sm:px-0">
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    {/* Header Row - Week Column + All Participants */}
                    <div className="flex bg-gray-100 border-b border-gray-200">
                      <div className="flex-shrink-0 w-20 sm:w-32 p-1 md:p-2 text-center text-xs md:text-sm font-medium text-gray-600 border-r border-gray-200">
                        <span className="hidden sm:inline">Week</span>
                        <span className="sm:hidden">W</span>
                      </div>
                      {participants.map(p => (
                        <div key={p.uid} className="flex-shrink-0 w-12 sm:w-16 p-1 md:p-2 text-center text-xs md:text-sm font-medium text-gray-600 border-r border-gray-200 last:border-r-0">
                    ...
                    {/* Totals Row */}
                    <div className="flex bg-gray-100 border-b border-gray-200">
                      <div className="flex-shrink-0 w-20 sm:w-32 p-1 md:p-2 text-center text-xs md:text-sm font-bold text-gray-700 border-r border-gray-200">
                      ...
                      {participants.map(p => {
                        ...
                        return (
                          <div key={p.uid} className="flex-shrink-0 w-12 sm:w-16 p-1 md:p-2 text-center text-xs md:text-sm font-bold text-gray-700 border-r border-gray-200 last:border-r-0">
                            {colTotal}
                          </div>
                        )
                      })}
                    ...
                    {rows.weeks.map(([key, meta]) => {
                      ...
                      return (
                        <div key={key} className="flex border-b border-gray-200 last:border-b-0">
                          <div className="flex-shrink-0 w-20 sm:w-32 p-1 md:p-2 text-center text-xs md:text-sm font-medium bg-white border-r border-gray-200">
                          ...
                          {participants.map(p => (
                            <div key={p.uid} className="flex-shrink-0 w-12 sm:w-16 p-1 md:p-2 text-center text-xs md:text-sm bg-white border-r border-gray-200 last:border-r-0 hover:bg-gray-50">
                              {row.get(p.uid) || 0}
                            </div>
                          ))}
                        </div>
