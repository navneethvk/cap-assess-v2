...
import type { UserDoc, CCIDoc, CciUserLinkDoc, DocumentWithId } from '@/types/firestore';
...
const AssignUsers: React.FC = () => {
  ...
  const getAssignedCcis = (userId: string): DocumentWithId<CCIDoc>[] => {
      ...
      {dirtyUsers.size > 0 && (
        <StickyActionBar className="m3-sticky-bar">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="primary" size="primary-default" onClick={saveAllAssignments} className="px-3 py-2 text-xs sm:text-sm m3-tonal-button" disabled={isSaving}>
