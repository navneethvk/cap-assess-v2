...
const Stats: React.FC = () => {
  ...
  const rows = useMemo(() => {
    if (useFallback) {
      ...
      for (const weekDoc of insightData) {
        const weekStart = weekDoc.data.weekStart.toDate()
        const weekEnd = weekDoc.data.weekEnd.toDate()
        ...
        const roleCount = roleMode === 'EM' ? weekDoc.data.counts.byRole.em : weekDoc.data.counts.byRole.visitor
