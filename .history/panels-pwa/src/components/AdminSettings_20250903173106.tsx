...
const UserSettings: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'ccis', label: 'CCIs', icon: Building2, component: 'ccis' },
    { id: 'assignments', label: 'Assign', icon: UserPlus, component: 'assignments' }
  ];
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 overflow-x-auto overflow-y-hidden whitespace-nowrap no-scrollbar py-1 m3-chips">
                    <div className="flex gap-2">
                      {['All', 'Pending', 'EM', 'CM', 'Academy', 'Management', 'Guest', 'Admin'].map(role => (
                        <button
                          key={role}
