...
const AssignUsers: React.FC = () => {
  ...
  if (usersError || ccisError || linksError) {
    ...
    return (
      <Card className="shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            There were errors loading the required data. This might be a permission issue.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">
            If the issue persists, try logging out and logging back in to refresh your authentication token.
          </p>
        </CardContent>
      </Card>
    );
