                ...
                <div className="min-w-max px-2 sm:px-0">
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden min-w-full">
                    ...
                    <div className="flex bg-gray-100 border-b border-gray-200">
                      ...
                      {participants.map(p => (
                        <div key={p.uid} className="flex-shrink-0 w-16 sm:w-20 p-1 md:p-2 text-center text-xs md:text-sm font-medium text-gray-600 border-r border-gray-200 last:border-r-0">
                    ...
                    <div className="flex bg-gray-100 border-b border-gray-200">
                      ...
                      {participants.map(p => {
                        ...
                        return (
                          <div key={p.uid} className="flex-shrink-0 w-16 sm:w-20 p-1 md:p-2 text-center text-xs md:text-sm font-bold text-gray-700 border-r border-gray-200 last:border-r-0">
                            {colTotal}
                          </div>
                        )
                      })}
                    ...
                    {rows.weeks.map(([key, meta]) => {
                      ...
                      return (
                        <div key={key} className="flex border-b border-gray-200 last:border-b-0">
                          ...
                          {participants.map(p => (
                            <div key={p.uid} className="flex-shrink-0 w-16 sm:w-20 p-1 md:p-2 text-center text-xs md:text-sm bg-white border-r border-gray-200 last:border-r-0 hover:bg-gray-50">
                              {row.get(p.uid) || 0}
                            </div>
                          ))}
                        </div>
