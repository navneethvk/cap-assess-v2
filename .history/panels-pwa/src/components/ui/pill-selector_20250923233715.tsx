...
export const PillSelector: React.FC<PillSelectorProps> = ({ 
  ...
  const iconSource = currentOption ?? (value === placeholderValue ? resolvedPlaceholderOption : undefined);
  ...
  const isPlaceholderSelected = value === placeholderValue || (!currentOption && placeholderValue !== undefined);
