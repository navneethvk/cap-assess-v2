...
export const useFirestoreSelectOptions = <T extends { id: string }>(
  ...
  const [options] = React.useState<TextSelectOption[]>([]);
  ...
  return (
    <div className={cn('w-full', className)}>
      <Select value={value} onValueChange={onChange} disabled={isDisabled}>
        ...
        <SelectContent className={cn('bg-card text-foreground border border-border max-h-[320px] overflow-y-auto', contentClassName)}>
          {isLoading ? (
