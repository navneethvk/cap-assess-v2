          ...
          <div className="flex items-center gap-3 w-full">
            ...
            {showClearButton && hasValue && (
              <Button
                variant="ghost"
                size="sm"
                className="h-6 w-6 p-0 hover:bg-error-container/20 text-error rounded-full"
                onClick={handleClear}
              >
                <X className="h-3 w-3" />
              </Button>
          ...
          <div className="m3-card">
            <div className="p-4">
              <Calendar
                ...
                selected={isRangeMode ? (tempValue as DateRangeValue) : (tempValue as Date)}
