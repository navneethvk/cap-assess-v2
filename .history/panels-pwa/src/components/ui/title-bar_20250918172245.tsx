...
export const TitleBar: React.FC<TitleBarProps> = ({
  ...
  if (isCustom) {
    return (
      <div className="title-bar bg-gray-100 border-b border-gray-200 py-1.5 flex flex-col items-center gap-2 px-2 sm:flex-row sm:justify-between">
        <div className="flex items-center gap-2 min-w-0 flex-shrink-0 order-1 sm:order-none">
          {customLeft}
        </div>
        <div className="flex items-center justify-center min-w-0 flex-1 px-2 order-2">
          {customCenter}
        </div>
        <div className="flex items-center justify-center gap-2 min-w-0 flex-shrink-0 order-3">
          {customRight}
        </div>
      </div>
    );
  ...
  return (
    <div className="title-bar bg-gray-100 border-b border-gray-200 py-1.5 grid grid-cols-3 items-center">
      ...
      <div className="justify-self-center">
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <SelectPrimitive.Trigger className="w-28 sm:w-32 md:w-40 h-6 text-xs bg-transparent border-none text-gray-700 hover:text-gray-900 transition-colors px-1 flex items-center justify-center outline-none focus:outline-none">
              <SelectValue />
