...
export const TitleBar: React.FC<TitleBarProps> = ({
  ...
  if (isCustom) {
    return (
      <div className="title-bar bg-gray-100 border-b border-gray-200 py-1.5 flex items-center justify-between gap-2 px-2">
        ...
        <div className="flex items-center justify-center sm:justify-end gap-2 min-w-0 flex-shrink-0">
          {customRight}
        </div>
      </div>
    );
