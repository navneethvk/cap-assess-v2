...
const MobileCreateSheet: React.FC<MobileCreateSheetProps> = ({ isOpen, onClose, title = 'Create', initialDate }) => {
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          <CreateVisitForm
            ...
            onSave={(visitId) => {
              onClose()
              // Could navigate to the new visit or show success message
            }}
            onCancel={onClose}
            className="px-0 py-0"
          />
