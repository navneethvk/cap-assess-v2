      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          {isAdmin && pendingCount > 0 && (
            <div className="flex items-center justify-between gap-2 p-3 bg-warning/10 border border-warning/20 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-info">
                    Having permission issues? Try refreshing your authentication token.
                  </span>
                </div>
                <Button
                  onClick={async () => {
                    if (user) {
                      try {
                        ...
                        notify.error('Failed to refresh token. Please log out and log back in.');
                      }
                    }
                  }}
                  variant="outline"
