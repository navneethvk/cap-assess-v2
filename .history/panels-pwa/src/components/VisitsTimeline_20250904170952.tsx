  ...
  return (
    ...
    >
      ...
      <Card className={`relative mb-4 transition-all duration-200 bg-white dark:bg-[hsl(var(--card))] border border-blue-100/70 dark:border-foreground/20 rounded-xl shadow-md ${anyDragging ? 'max-h-16 overflow-hidden' : ''}`}>
        {/* Pointer (speech-bubble tail) towards spine */}
        <span className="hidden md:block absolute top-6 w-0 h-0 border-y-[8px] border-y-transparent border-r-[12px] border-r-white drop-shadow-sm"
          style={{
            left: '-12px'
          }}
        />
    ...
    <div className="mt-4 relative">
      ...
      <div
        ...
        onMouseMove={(e) => {
          ...
          const pageY = y + containerRect.top + window.scrollY
