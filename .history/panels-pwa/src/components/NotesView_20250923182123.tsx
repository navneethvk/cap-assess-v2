...
const NotesView: React.FC = () => {
  ...
  useEffect(() => {
    if (allVisits) {
      console.log('NotesView - Got visits:', allVisits.length);
      console.log('NotesView - Visit IDs:', allVisits.map(v => v.id));
    }
  }, [allVisits]);
  ...
  const handleCardClick = (visitId: string) => {
    console.log('NotesView - Navigating to visitId:', visitId);
