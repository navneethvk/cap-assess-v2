...
const Stats: React.FC = () => {
  ...
  const participants = useMemo(() => {
    ...
    console.log('Stats Debug - mostRecentWeek.userBreakdown:', {
      perUserStats: mostRecentWeek?.userBreakdown?.perUserStats ? Object.keys(mostRecentWeek.userBreakdown.perUserStats) : 'not available',
      topUsers: mostRecentWeek?.userBreakdown?.topUsers ? mostRecentWeek.userBreakdown.topUsers.length : 'not available',
      userStats: mostRecentWeek?.userBreakdown?.userStats ? Object.keys(mostRecentWeek.userBreakdown.userStats) : 'not available',
      usersByRole: mostRecentWeek?.userBreakdown?.usersByRole
    })
