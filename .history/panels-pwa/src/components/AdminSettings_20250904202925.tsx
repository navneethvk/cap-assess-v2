                    ...
                    <form className="p-4 border-b bg-muted/30" onSubmit={async (e) => {
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 items-end">
                        ...
                        <div>
                          ...
                          <input className="mt-1 w-full rounded-md border px-3 py-2 text-sm" type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="At least 6 characters" />
                        </div>
                        <div>
