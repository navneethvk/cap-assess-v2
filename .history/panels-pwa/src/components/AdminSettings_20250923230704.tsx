        ...
        {isAdmin ? (
            ...
            <TabsContent value="users" className="space-y-6">
              <Card className="m3-card">
                ...
                <CardContent className="p-0">
                  ...
                  {firestoreError && !loadingUsers && (
                    <div className="p-4 bg-destructive/10 border-b border-destructive/20">
                      <p className="text-sm text-destructive">{firestoreError?.message || 'Error occurred'}</p>
                    </div>
                  )}
          ...
          {hasChanges && (
            <StickyActionBar className="m3-sticky-bar">
              ...
              <Button variant="primary" size="primary-default" onClick={handleSaveChanges} className="px-3 py-2 text-xs sm:text-sm m3-tonal-button">
