                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      {participants.map(p => (
                        <TableHead key={p.uid} className="whitespace-nowrap min-w-[120px] text-center">{p.label}</TableHead>
                      ))}
                      <TableHead className="whitespace-nowrap min-w-[80px] text-center font-bold">Total</TableHead>
                    </TableRow>
                    {/* Column totals row */}
                    <TableRow>
                      <TableHead className="sticky left-0 bg-background z-10 min-w-[200px] font-bold">Total</TableHead>
                      {participants.map(p => {
                        ...
                        return (
                          <TableHead key={p.uid} className="whitespace-nowrap min-w-[120px] text-center font-bold">{colTotal}</TableHead>
                        )
                      })}
                      <TableHead className="whitespace-nowrap min-w-[80px] text-center font-bold">
