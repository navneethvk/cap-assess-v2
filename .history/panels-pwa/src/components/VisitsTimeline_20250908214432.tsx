...
const TimelineCard: React.FC<{ 
  ...
  // Auto-complete status for existing visits with debrief content or personMet (only if user hasn't manually set status)
  React.useEffect(() => {
    const checkAndUpdateStatus = async () => {
      if (v.status !== 'Complete' && !userManuallySetStatus) {
  ...
  }, [v.debrief, v.personMet, v.status, userManuallySetStatus])
