...
const TimelineCard: React.FC<{ 
  ...
  return (
    ...
    >
      ...
      <Card className={`mb-4 transition-all duration-200 bg-white dark:bg-[hsl(var(--card))] border border-blue-100/70 dark:border-foreground/20 rounded-xl shadow-md ${anyDragging ? 'max-h-16 overflow-hidden' : ''} border-t-4 border-t-[hsl(var(--primary))]`}>
        <CardHeader 
