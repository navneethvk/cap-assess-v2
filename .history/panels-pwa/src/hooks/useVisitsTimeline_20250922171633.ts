...
const DEBUG_VISITS_TIMELINE = process.env.NODE_ENV === 'development' && false; // Disabled by default
...
export const useVisitsTimeline = (): VisitsTimelineState => {
  ...
  const visits = useMemo(() => {
    console.log('useVisitsTimeline - allVisits:', allVisits)
    ...
    console.log('useVisitsTimeline - filtered visits:', filtered)
    return filtered
