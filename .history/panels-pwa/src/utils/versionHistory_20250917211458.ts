...
export interface VersionEvent {
  ...
  userName: string;
  timestamp: Date;
  isSnapshot?: boolean; // Whether this event is part of a snapshot
  snapshotId?: string; // ID of the snapshot this event belongs to
  snapshotVersion?: number; // Version number of the snapshot
  metadata?: {
